am4internal_webpackJsonp(["cc1e"],
{
    QJ7E: function(t, e, n)
    {
        ...
        function ut(t, e)
        {
            rt.point = st, J = t, K = e, Q = t *= C, $ = T(e = (e *= C) / 2 + w), tt = F(e)
        }
        ...
        var mt, yt, bt, Pt, St, _t, Mt, xt, wt, jt, Lt = m(),
            Ct = {
                point: Et,
                lineStart: It,
                lineEnd: Tt,
                ...
                polygonEnd: function()
                {
                    rt.polygonEnd(), Ct.point = Et, Ct.lineStart = It, Ct.lineEnd = Tt, nt < 0 ? (mt = -(bt = 180), yt = -(Pt = 90)) : Lt > S ? Pt = 90 : Lt < -S && (yt = -90), jt[0] = mt, jt[1] = bt
                },
                sphere: function()
                {
                    mt = -(bt = 180), yt = -(Pt = 90)
        ...
        function Tt()
        {
            jt[0] = mt, jt[1] = bt, Ct.point = Et, xt = null
        }
        ...
        function Gt(t, e)
        {
            ...
            {
                var n = t - St;
                Lt.add(E(n) > 180 ? n + (n > 0 ? 360 : -360) : n)
            }
            else _t = t, Mt = e;
            rt.point(t, e), Ot(t, e)
        }
        ...
        function Nt()
        {
            Gt(_t, Mt), rt.lineEnd(), E(Lt) > S && (mt = -(bt = 180)), jt[0] = mt, jt[1] = bt, xt = null
        }
        ...
        var Vt, Rt, kt, Bt, Wt, Ht, Zt, qt, Xt, Yt, Ut, Jt, Kt, Qt, $t, te, ee = function(t)
            {
                ...
                {
                    for (wt.sort(Ft), e = 1, o = [i = wt[0]]; e < n; ++e) At(i, (r = wt[e])[0]) || At(i, r[1]) ? (zt(i[0], r[1]) > zt(i[0], i[1]) && (i[1] = r[1]), zt(r[0], i[1]) > zt(i[0], i[1]) && (i[0] = r[0])) : o.push(i = r);
                    for (a = -1 / 0, e = 0, i = o[n = o.length - 1]; e <= n; i = r, ++e) r = o[e], (u = zt(i[1], r[0])) > a && (a = u, mt = r[0], bt = i[1])
                }
                return wt = jt = null, mt === 1 / 0 || yt === 1 / 0 ? [
                    [NaN, NaN],
                    [NaN, NaN]
                ] : [
                    [mt, yt],
        ...
        function ve(t, e)
        {
            return [E(t) > M ? t + Math.round(-t / j) * j : t, e]
        }
        ...
        var xe = function()
            {
                ...
                function a()
                {
                    var a = n.apply(this, arguments),
                        u = i.apply(this, arguments) * C,
                        s = r.apply(this, arguments) * C;
            ...
            je = function(t, e)
            {
                return E(t[0] - e[0]) < S && E(t[1] - e[1]) < S
            };
        ...
        var Ce = function(t, e, n, i, r)
        {
            ...
            {
                for (s.sort(e), Ee(u), Ee(s), o = 0, a = s.length; o < a; ++o) s[o].e = n = !n;
                for (var c, l, h = u[0];;)
                {
                    for (var p = h, f = !0; p.v;)
                        if ((p = p.n) === h) return;
        ...
        function Ie(t)
        {
            return E(t[0]) <= M ? t[0] : A(t[0]) * ((E(t[0]) + M) % j - M)
        }
        var Te = function(t, e)
            {
                var n = Ie(e),
                    ...
                    a = 0,
                    u = 0;
                Oe.reset(), 1 === r ? i = x + S : -1 === r && (i = -x - S);
                for (var s = 0, c = t.length; s < c; ++s)
                    if (h = (l = t[s]).length)
                        for (var l, h, p = l[h - 1], f = Ie(p), d = p[1] / 2 + w, g = F(d), v = T(d), m = 0; m < h; ++m, f = b, g = _, v = L, p = y)
                        {
                            var y = l[m],
                                b = Ie(y),
                                P = y[1] / 2 + w,
                                ...
                                G = O > M,
                                D = g * _;
                            if (Oe.add(I(D * E * F(O), v * L + D * T(O))), a += G ? C + E * j : C, G ^ f >= n ^ b >= n)
                            {
                                var N = ft(ht(p), ht(y));
                                vt(N);
                                var z = ft(o, N);
                                vt(z);
                                var A = (G ^ C >= 0 ? -1 : 1) * B(z[2]);
                                (i > A || i === A && (N[0] || N[1])) && (u += G ^ C >= 0 ? 1 : -1)
                            }
                        }
                return (a < -S || a < S && Oe < -S) ^ 1 & u
            },
            Ge = function(t, e)
            {
        ...
        }, function(t)
        {
            ...
            return {
                ...
                point: function(o, a)
                {
                    var u = o > 0 ? M : -M,
                        s = E(o - n);
                    E(s - M) < S ? (t.point(n, i = (i + a) / 2 > 0 ? x : -x), t.point(r, i), t.lineEnd(), t.lineStart(), t.point(u, i), t.point(o, i), e = 0) : r !== u && s >= M && (E(n - r) < S && (n -= r * S), E(o - u) < S && (o -= u * S), i = function(t, e, n, i)
                    {
                        var r, o, a = F(t - n);
                        return E(a) > S ? O((F(e) * (o = T(i)) * F(n) - F(i) * (r = T(e)) * F(t)) / (r * o * a)) : (e + i) / 2
        ...
        var Be = function(t)
            {
                ...
                function a(t, n, i)
                {
                    ...
                    if (!(v < 0))
                    {
                        ...
                        var j = _ - P,
                            L = E(j - M) < S;
                        if (!L && w < x && (b = x, x = w, w = b), L || j < S ? L ? x + w > 0 ^ y[1] < (E(y[0] - P) < S ? x : w) : x <= y[1] && y[1] <= w : j > M ^ (P <= y[0] && y[0] <= _))
                        {
                            var C = gt(f, (-d + m) / g);
                ...
                return Ae(o, function(t)
                {
                    ...
                    return {
                        ...
                        point: function(h, p)
                        {
                            ...
                            if (!e && (c = s = g) && t.lineStart(), g !== s && (!(f = a(e, d)) || je(e, f) || je(d, f)) && (d[0] += S, d[1] += S, g = o(d[0], d[1])), g !== s) l = 0, g ? (t.lineStart(), f = a(d, e), t.point(f[0], f[1])) : (f = a(e, d), t.point(f[0], f[1]), t.lineEnd()), e = f;
                            else if (r && e && i ^ g)
                            {
                                var m;
        ...
        function qe(t, e, n, i)
        {
            ...
            function a(i, r)
            {
                return E(i[0] - t) < S ? r > 0 ? 0 : 3 : E(i[0] - n) < S ? r > 0 ? 2 : 1 : E(i[1] - e) < S ? r > 0 ? 1 : 0 : r > 0 ? 3 : 2
            }
        ...
        function tn(t, e)
        {
            Xe = t *= C, Ye = F(e *= C), Ue = T(e), Qe.point = en
        }
        ...
        var Pn, Sn, _n, Mn, xn = function(t, e)
            ...
            Cn = {
                ...
                polygonStart: function()
                {
                    Cn.lineStart = En, Cn.lineEnd = Tn
                },
                polygonEnd: function()
                {
                    Cn.lineStart = Cn.lineEnd = Cn.point = H, jn.add(E(Ln)), Ln.reset()
                },
                result: function()
                {
                    var t = jn / 2;
                    ...
                    function n(i, r, o, a, u, s, c, l, h, p, f, d, g, v)
                    {
                        ...
                        if (b > 4 * e && g--)
                        {
                            var P = a + p,
                                ...
                                x = V(P * P + _ * _ + M * M),
                                w = B(M /= x),
                                j = E(E(M) - 1) < S || E(o - h) < S ? (o + h) / 2 : I(_, P),
                                L = t(j, w),
                                C = L[0],
                                O = L[1],
                                T = C - i,
                                G = O - r,
                                D = y * T - m * G;
                            (D * D / b > e || E((m * T + y * G) / b - .5) > .3 || a * p + u * f + s * d < Ti) && (n(i, r, o, a, u, s, C, O, j, P /= x, _ /= x, M, g, v), v.point(C, O), n(C, O, j, P, _, M, c, l, h, p, f, d, g, v))
                        }
                    }
                    return function(e)
                    {
        ...
        function Fi(t)
        {
            ...
            function E()
            {
                ...
                return n = me(v, m, y), u = ge(e, i), s = ge(n, u), a = Gi(u, x), O()
            }
            ...
            return w.stream = function(t)
                ...
                {
                    return arguments.length ? (S = +t ? Be(P = t * C) : (P = null, ke), O()) : P * L
                }, w.clipExtent = function(t)
                {
                    return arguments.length ? (M = null == t ? (_ = i = r = o = null, wn) : qe(_ = +t[0][0], i = +t[0][1], r = +t[1][0], o = +t[1][1]), O()) : null == _ ? null : [
                        [_, i],
                        [r, o]
                    ]
                }, w.scale = function(t)
                ...
                {
                    return arguments.length ? (d = t[0] % 360 * C, g = t[1] % 360 * C, E()) : [d * L, g * L]
                }, w.rotate = function(t)
                {
                    return arguments.length ? (v = t[0] % 360 * C, m = t[1] % 360 * C, y = t.length > 2 ? t[2] % 360 * C : 0, E()) : [v * L, m * L, y * L]
                }, w.angle = function(t)
                {
                    return arguments.length ? (b = t % 360 * C, E()) : b * L
                }, w.precision = function(t)
                {
                    return arguments.length ? (a = Gi(u, x = t * t), O()) : V(x)
                ...
                function()
                {
                    return e = t.apply(this, arguments), w.invert = e.invert && j, E()
                }
        }
        ...
        function Vi(t, e)
        {
            ...
            {
                var n = o - e;
                return [I(t, E(n)) / i * A(n), B((r - (t * t + n * n) * i * i) / (2 * i))]
            }, a
        }
        var Ri = function()
            {
                return Ai(Vi).scale(155.424).center([0, 33.6442])
            },
            ki = function()
            {
        ...
        function $i(t, e)
        {
            ...
            return o.invert = function(t, e)
            {
                var n = r - e,
                    o = A(i) * V(t * t + n * n);
                return [I(t, E(n)) / i * A(n), 2 * O(z(r / o, 1 / i)) - x]
            }, o
        }
        var tr = function()
        {
        ...
        function ir(t, e)
        {
            ...
            {
                var n = r - e;
                return [I(t, E(n)) / i * A(n), r - A(i) * V(t * t + n * n)]
            }, o
        }
        var rr = function()
            {
        ...
        {
            for (var n, i = e, r = i * i, o = r * r * r, a = 0; a < 12 && (o = (r = (i -= n = (i * (or + ar * r + o * (ur + sr * r)) - e) / (or + 3 * ar * r + o * (7 * ur + 9 * sr * r))) * i) * r * r, !(E(n) < _)); ++a);
        ...
        var gr = function()
        {
            ...
            return o = {
                ...
                {
                    return arguments.length ? (f = null == i ? (p = t = e = n = null, wn) : qe(p = +i[0][0], t = +i[0][1], e = +i[1][0], n = +i[1][1]), d()) : null == p ? null : [
                        [p, t],
                        [e, n]
                    ]
                },
        ...
        var Wr = function(t)
        {
            ...
            {
                var e = t.call(this) || this;
                e.className = "MapPolygon", e.polygon = e.createChild(Er.a), e.polygon.shouldClone = !1, e.polygon.applyOnClones = !0;
                var n = new p.a;
        ...
        var fo = function(t)
            {
                ...
                }), Object.defineProperty(e.prototype, "geoLine",
                {
                    ...
                    set: function(t)
                    {
                        this._geoLine = t, this.multiLine = Vr([t])
                    },
                    enumerable: !0,
                    configurable: !0
                }), Object.defineProperty(e.prototype, "multiGeoLine",
                {
                    ...
                    set: function(t)
                    {
                        this._multiGeoLine = t, this.multiLine = Vr(t)
                    },
                    enumerable: !0,
                    configurable: !0
                }), e
            ...
            So = function(t)
            {
                function e()
                {
                    ...
                    e.scaleRatio = 1, e.zoomDuration = 1e3, e.zoomEasing = eo.cubicOut, e.minZoomLevel = 1, e.maxZoomLevel = 32, e._prevZoomGeoPoint = {
                        latitude: 0,
                        longitude: 0
                    }, e.className = "MapChart", e.projection = new Ur, e.deltaLongitude = 0, e.deltaLatitude = 0, e.deltaGamma = 0, e.maxPanOut = .7, e.homeZoomLevel = 1, e.zoomStep = 2, e.layout = "absolute", e.padding(0, 0, 0, 0), Zr.used(e.backgroundSeries), e.minWidth = 10, e.minHeight = 10, e.events.once("inited", e.handleAllInited, e, !1);
                ...
                }), e.prototype.zoomToGeoPoint = function(t, e, n, i)
                {
                    ...
                    if (t || (t = this.zoomGeoPoint), t && g.isNumber(t.longitude) && g.isNumber(t.latitude))
                    {
                        ...
                        if (o)
                        {
                            var a = this.geoPointToSVG(t),
                                u = Zr.svgPointToSprite(a, this);
                            return n && (u = {
                                x: this.innerWidth / 2,
                ...
                }, e.prototype.zoomToMapObject = function(t, e, n, i)
                {
                    ...
                    var r = t.dataItem;
                    if (r && g.isNumber(r.zoomLevel) && (e = r.zoomLevel), t instanceof Wr)
                    {
                        var o = t.dataItem,
                            a = t.polygon.bbox;
                        ...
                        else
                        {
                            var s = {
                                ...
                                c = Zr.spritePointToSprite(s, t.polygon, t.series);
        ...
        d.b.registeredClasses.MapSplineSeries = Lo, d.b.registeredClasses.MapSplineSeriesDataItem = jo;
        var Co = function(t)
            {
                function e()
                {
        ...
        d.b.registeredClasses.MapArcSeries = Eo, d.b.registeredClasses.MapArcSeriesDataItem = Co;
        var Oo = n("aGXA"),
            Io = n("CnhP"),
            To = function(t)
            {
        ...
        var Va = function(t, e, n, i, r, o, a, u)
        {
            function s(s, c)
            {
            ...
            return arguments.length < 8 && (u = 0), s.invert = function(s, c)
            {
                ...
                do {
                    var g = f * f,
                        ...
                        V = N * A - F * z;
                    if (!V) break;
                    p -= l = (D * N - G * F) / V, f -= h = (G * A - D * z) / V
                } while ((Do(l) > Xo || Do(h) > Xo) && --d > 0);
                return [p, f]
            }, s
        };
        Va(2.8284, -1.6988, .75432, -.18071, 1.76003, -.38914, .042555), Va(2.583819, -.835827, .170354, -.038094, 1.543313, -.411435, .082742), Va(5 / 6 * Uo, -.62636, -.0344, 0, 1.3493, -.05524, 0, .045);
        ...
        Va(2.6516, -.76534, .19123, -.047094, 1.36289, -.13965, .031762);
        ...
        cu.invert = function(t, e)
        {
            var n = (t /= Jo) * t,
                i = n + (e /= Jo) * e,
                r = Uo * Uo;
            return [t ? (i - 1 + aa((1 - i) * (1 - i) + 4 * n)) / (2 * t) * Jo : 0, Aa(function(t)
            {
        ...
        }), xu.invert = function(t, e)
        {
            ...
            do {
                ...
                if (f >= 0 || 1 === o)
                {
                    ...
                    var d, g = 50;
                    do {
                        f = (r = Bo(18, Do(i) / 5)) - (o = Vo(r)), a = Mu[o][1], u = Mu[o + 1][1], s = Mu[Bo(19, o + 2)][1], i -= (d = (e >= 0 ? Jo : -Jo) * (u + f * (s - a) / 2 + f * f * (s - 2 * u + a) / 2) - e) * na
                    } while (Do(d) > Yo && --g > 0);
                    break
                }
            } while (--o >= 0);
        ...
        var Ou = 4 * Uo + 3 * aa(3),
            Iu = 2 * aa(2 * Uo * aa(3) / Ou);
        va(Iu * aa(3) / Uo, Iu, Ou / 6);
        ...
        d.b.registeredClasses.Stereographic = Vu;
        var Ru = function(t)
        {
            function e()
            {
